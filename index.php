...
<body> 
					...
					while ($data = mysqli_fetch_assoc($result)) {
						...
						<div class='card'>
							<div class='card-image'>
								<img src='./img_kategori/$data[photo]' alt='tidak ada gambar' />
							</div>
			...
			<div id="myModal2" class="modal-container" onclick="tutupModal2()">
				<div class="modal-dialog" onclick="event.stopPropagation()">
					<div class="modal-content">
						...
						<form action="informasi-proses.php" method="post">
							<div class="modal-body">
								<h4> Kategori</h4>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="labelmodal" for="detail-nomor" class="col-form-label">No. Hp
										:</label>
    ...
    <script>
		...
		function bukaModal(categoryId) {
			...
			xhr.open("GET", "get-kategori.php?" + categoryId, true);
			xhr.send();
		}
		...
		function bukaModal2() {
			...
			var nomor = document.getElementById("handphone").value;
			var seat = document.getElementById("seat-text").value;
			// kategori
			...
			document.getElementById("detail-seat").value = seat;
